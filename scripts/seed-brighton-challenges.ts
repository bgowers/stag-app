...
const challenges = [
  ...
  {
    title: 'Darts Ton+',
    description: 'Score 60+ in a single turn of darts.\n\nBonus: Score 100+ in a single turn.',
    base_points: 2,
    bonus_points: 3,
    category: 'friday',
    sort_order: 2,
  },
  {
    ...
    description: 'Score 15+ in a single shuffleboard round.\n\nBonus: Win a full shuffleboard match.',
    base_points: 2,
    bonus_points: 2,
    category: 'friday',
    sort_order: 3,
  },
  {
    ...
    description: 'Get 2 bags in the hole in a single round.\n\nBonus: Get 3+ bags in the hole in one round.',
    base_points: 2,
    bonus_points: 2,
    category: 'friday',
    sort_order: 4,
  },
  {
    ...
    description: 'Start a friendly conversation with another group and get a photo (consensual).\n\nBonus: Convince them you\'re in Brighton for a professional sporting tournament.',
    base_points: 2,
    bonus_points: 3,
    category: 'friday',
    sort_order: 5,
  ...
  {
    title: 'Clean Racer',
    description: 'Complete a race without spinning out.\n\nBonus: Finish top 2 in the race.',
    base_points: 2,
    bonus_points: 2,
    category: 'saturday',
    sort_order: 7,
  ...
  // Public Brighton Missions
  {
    ...
    description: 'Eat food outside without being attacked by a seagull.\n\nBonus: Successfully protect someone else\'s food from a seagull.',
    base_points: 2,
    bonus_points: 3,
    category: 'public',
    sort_order: 10,
  ...
  {
    title: 'Beach Orator',
    description: 'Deliver a dramatic speech to the sea including the word "brotherhood".\n\nBonus: Include the phrase "seagulls are witnesses".',
    base_points: 3,
    bonus_points: 2,
    category: 'public',
    sort_order: 11,
  },
  {
    ...
    description: 'Spot someone in glitter or dramatic Brighton fashion.\n\nBonus: Get a group photo (with permission).',
    base_points: 2,
    bonus_points: 3,
    category: 'public',
    sort_order: 12,
  ...
  // Drinking Games
  {
    ...
    description: 'Someone says "stag", "wedding", or the partner\'s name and you catch it.',
    base_points: 1,
    bonus_points: null,
    category: 'drinking',
    sort_order: 14,
  },
  {
    ...
    description: 'Stay in a chosen character for 10 full minutes.\n\nBonus: Make a stranger believe the character is real.',
    base_points: 2,
    bonus_points: 3,
    category: 'drinking',
    sort_order: 15,
  ...
  },
  {
    ...
    description: 'Successfully complete a secret mission assigned by another player.\n\nBonus: No one realises until revealed later.',
    base_points: 2,
    bonus_points: 3,
    category: 'wildcard',
    sort_order: 17,
...
async function seedChallenges(gameId: string) {
  console.log(`🌱 Seeding ${challenges.length} challenges for game: ${gameId}\n`);
...
if (!gameId) {
  ...
  console.error('Usage: npx tsx scripts/seed-brighton-challenges.ts YOUR_GAME_ID');
  process.exit(1);
}
